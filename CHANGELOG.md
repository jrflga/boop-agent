...
- **[BREAKING]** Replaced Sendblue/iMessage transport with Telegram Bot API webhooks and `sendMessage`. Configure `TELEGRAM_BOT_TOKEN`, `TELEGRAM_WEBHOOK_SECRET`, `TELEGRAM_ALLOWED_CHAT_IDS`, and `ADMIN_TOKEN`.
